...
public abstract class ReactionsFaceAnimationCallback {
  ...
  /**
   * Creates a ReactionsFaceAnimationCallback appropriate for the API level of the device.
   * @param listener The listener that will receive callbacks on updates to the value
   * @return A ReactionsFaceAnimationCallback implementation
   */
  public static ReactionsFaceAnimationCallback create(
  ...
  private ReactionsFaceAnimationCallback(FrameListener listener, int frameRate, int frameCount) {
  ...
  @TargetApi(16)
  private static class FrameCallbackFaceAnimationCallback extends ReactionsFaceAnimationCallback
  ...
  private static class RunnableFaceAnimationCallback extends ReactionsFaceAnimationCallback
      implements Runnable {
