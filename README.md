...
1. Ensure that you are in the same directory where this `README.md` exists (e.g., it could be in a `docs` folder on `master`, in the root of a `gh-pages` branch, etc). The below RubyGems commands, etc. must be run from there.
