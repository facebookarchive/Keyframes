## User Documentation for Keyframes

This directory will contain the user and feature documentation for Keyframes. The documentation will be hosted on GitHub pages.
...
1. Ensure that you are in the same directory where this `README.md` exists (e.g., it could be in `keyframes/docs` on `master`, in the root of a `gh-pages` branch, etc). The below RubyGems commands, etc. must be run from there.
